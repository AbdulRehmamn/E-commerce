      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Contemporary clothing for the modern individual. Designed with intention and crafted to last.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/products?category=new-arrivals" className="text-gray-400 hover:text-white transition-colors">New Arrivals</Link>
              </li>
              <li>
                <Link to="/products?category=bestsellers" className="text-gray-400 hover:text-white transition-colors">Bestsellers</Link>
              </li>
              <li>
                <Link to="/products?category=essentials" className="text-gray-400 hover:text-white transition-colors">Essentials</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Sustainability</a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex items-center space-x-4">
            <img src="https://via.placeholder.com/36x24" alt="Visa" className="h-6" />
            <img src="https://via.placeholder.com/36x24" alt="Mastercard" className="h-6" />
            <img src="https://via.placeholder.com/36x24" alt="American Express" className="h-6" />
            <img src="https://via.placeholder.com/36x24" alt="PayPal" className="h-6" />
          </div>
        </div>
      </div>
    </footer>
